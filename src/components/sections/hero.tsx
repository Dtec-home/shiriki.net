 ...
 * overlay, a label, the page's single `<h1>`, a lead paragraph, and two CTAs
 * — an anchor link into the giving section, and the demo dialog.
 *
...
export function Hero({
  ...
  return (
    <section className="relative overflow-hidden bg-primary text-primary-foreground">
      ...
      />
      <Container size="content" className="relative flex flex-col py-16 lg:py-24">
        <FadeInUp className="flex flex-col">
          ...
          <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:self-start">
